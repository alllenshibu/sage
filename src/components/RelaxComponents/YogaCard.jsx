...
const YogaCard = ({yoga}) => {
  return (
    <Link href={`/relax/${yoga.id}`}>
    <div className='w-300 h-455 bg-white border-t-2 rounded-bl-20 border-blue-500 flex justify-between flex-col pb-3 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-indigo-100 duration-300'>
